...
<div align="center">
    <img width="800" alt="teaser" src="assets/single_wavelet.pdf"/>
</div>
...
## Inference ##
Samples can be generated by calling ```test_wddgan.py``` in [run.sh](./run.sh).
...
### Recall ###
We adopt the official implementation of [StyleGAN2-ADA](https://github.com/NVlabs/stylegan2-ada-pytorch.git) to compute Recall of generated samples.
