...
def sample_and_test(args):
    ...
    save_dir = "./wddgan_generated_{}/{}".format(args.exp,args.dataset)

    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    
    for epoch_id in args.epoch_id:
        ckpt = torch.load('./saved_info/wdd_gan/{}/{}/netG_{}.pth'.format(args.dataset, args.exp, epoch_id), map_location=device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--no_use_fred", action="store_true")
