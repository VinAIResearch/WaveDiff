#!/bin/sh
#SBATCH --job-name=hi64 # create a short name for your job
...
# ----------------- Wavelet -----------
# 1 2 2 2
# python train_wddgan.py --dataset cifar10 --exp wddgan_cifar10_exp1_noatn_g122_d2_1800ep --num_channels 3 --num_channels_dae 128 --num_timesteps 4 \
#     --num_res_blocks 2 --batch_size 256 --num_epoch 1800 --ngf 64 --nz 100 --z_emb_dim 256 --n_mlp 4 --embedding_type positional \
#     --use_ema --ema_decay 0.9999 --r1_gamma 0.02 --lr_d 1.25e-4 --lr_g 1.6e-4 --lazy_reg 15 \
...
# python test_wddgan.py --dataset cifar10 --exp wddgan_cifar10_exp1_atn8_wgd_1000ep --num_channels 3 --num_channels_dae 128 --num_timesteps 4 \
# 	--num_res_blocks 2 --nz 100 --z_emb_dim 256 --n_mlp 4 --ch_mult 1 2 2 2 --epoch_id 700 \
#     --use_pytorch_wavelet \
#     --infer_mode both \
#     --image_size 32 \
#     --current_resolution 16 \
...
# --------------------- MULTISCALE WAVELET
# python train_multiscale_wddgan.py --dataset celeba_256 --image_size 256 --exp multiscale_wddgan_celebahq_exp5_hi64_recloss_1step_g1222_d4_200ep --num_channels_dae 128 --num_timesteps 1 \
