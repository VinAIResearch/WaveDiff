#!/bin/sh
#SBATCH --job-name=gp3 # create a short name for your job
...
# ----------------- Wavelet -----------
# 1 2 2 2
# python train_wddgan.py --dataset cifar10 --exp wddgan_cifar10_exp2_noatn_wg122_d3_skiphH_bs64x2_1800ep --num_channels 3 --num_channels_dae 128 --num_timesteps 4 \
...
# 1 1 2 2 4 4
python train_wddgan.py --dataset celeba_256 --image_size 256 --exp wddgan_celebahq_exp1_both128_atn16_recloss_wg12224_wd5_500ep_skiphH --num_channels 12 --num_channels_dae 64 --ch_mult 1 2 2 2 4 --num_timesteps 2 \
...
# python train_wddgan.py --dataset lsun --image_size 256 --exp wddgan_lsun_exp1_wg12224_d5_400ep --num_channels 3 --num_channels_dae 64 --ch_mult 1 2 2 2 4 --num_timesteps 4 \
# --num_res_blocks 2 --batch_size 24 --num_epoch 400 --ngf 64 --embedding_type positional --use_ema --ema_decay 0.999 --r1_gamma 1. \
...
# python test_wddgan.py --dataset cifar10 --exp wddgan_cifar10_exp1_noatn_g122_d3_1200ep --num_channels 3 --num_channels_dae 128 --num_timesteps 4 \
...
#1 1 2 2 4 4
# python3 test_wddgan.py --dataset celeba_256 --image_size 256 --exp wddgan_celebahq_exp1_both128_atn16_recloss_wg12224_d5_500ep_skiphH --num_channels 3 --num_channels_dae 64 \
...
# python train_multiscale_wddgan_mag.py --dataset celeba_256 --image_size 256 --exp multiscale_wddgan_celebahq_exp6_hi64_recloss_maghloss_magh_2step_g12224_d4_100ep --num_channels_dae 64 --num_timesteps 2 \
# --num_res_blocks 2 --batch_size 64 --num_epoch 100 --ngf 64 --embedding_type positional --use_ema --r1_gamma 2. \
# --z_emb_dim 256 --lr_d 1e-4 --lr_g 2e-4 --lazy_reg 10 --save_content --datadir data/celeba/celeba-lmdb/ \
# --current_resolution 64 \
# --master_address $MASTER_ADDRESS --master_port $MASTER_PORT --num_process_per_node 1 \
...
# --exp multiscale_wddgan_celebahq_exp5_ll64_recloss_2step_g1222_d4_500ep multiscale_wddgan_celebahq_exp5_hi64_recloss_maghloss_2step_g1222_d4_100ep multiscale_wddgan_celebahq_exp3_hi128_scalell_200ep \
# --epoch_id 500 100 200 \
# --num_timesteps 2 2 2 \
