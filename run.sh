#!/bin/sh
#SBATCH --job-name=ci_natn2 # create a short name for your job
...
# python test_wddgan.py --dataset cifar10 --exp wddgan_cifar10_exp1_atn8_g122_d2_1800ep --num_channels 3 --num_channels_dae 128 --num_timesteps 4 \
