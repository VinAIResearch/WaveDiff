#!/bin/sh
#SBATCH --job-name=ti # create a short name for your job
...
# python test_wddgan.py --dataset cifar10 --exp wddgan_cifar10_exp1_noatn_wg122_d3_skiphH_1800ep --num_channels 3 --num_channels_dae 128 --num_timesteps 4 \
...
# --ch_mult 1 2 2 2 4 --num_timesteps 2 --num_res_blocks 2  --epoch_id 450 \
...
# --exp multiscale_wddgan_celebahq_exp5_ll64_recloss_2step_g1222_d4_500ep multiscale_wddgan_celebahq_exp5_hi64_recloss_1step_g1222_d4_200ep multiscale_wddgan_celebahq_exp5_hi128_recloss_1step_g12224_d5_200ep \
