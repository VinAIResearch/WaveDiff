#!/bin/sh
#SBATCH --job-name=gp_stl # create a short name for your job
...
# ----------------- Wavelet -----------
# 1 2 2 2
# python train_wddgan.py --dataset cifar10 --exp wddgan_cifar10_exp2_noatn_wg122_d3_recloss_bs64x4_1800ep --num_channels 3 --num_channels_dae 128 --num_timesteps 4 \
...
python train_wddgan.py --dataset stl10 --exp wddgan_stl10_exp1_atn16_wg1222_d4_recloss_900ep --num_channels 3 --num_channels_dae 128 --num_timesteps 4 \
...
# python train_wddgan.py --dataset lsun --image_size 256 --exp wddgan_lsun_exp1_new_wg12224_d5_500ep --num_channels 3 --num_channels_dae 64 --ch_mult 1 2 2 2 4 --num_timesteps 4 \
...
# python3 test_wddgan.py --dataset celeba_512 --image_size 512 --exp wddgan_celebahq_exp1_both256_atn16_recloss_new_wg112244_d5_400ep_skiphH --num_channels 3 --num_channels_dae 64 \
