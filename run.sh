...
#SBATCH --output=/lustre/scratch/client/vinai/users/haopt12/diffae/slurm_%A.out # create a output file
#SBATCH --error=/lustre/scratch/client/vinai/users/haopt12/diffae/slurm_%A.err # create a error file
...
python train_ddgan.py --dataset cifar10 --exp ddgan_p4_cifar10_exp1 --num_channels 3 --num_channels_dae 128 --num_timesteps 4 \
